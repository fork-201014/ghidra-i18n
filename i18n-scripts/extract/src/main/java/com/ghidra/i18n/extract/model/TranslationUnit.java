...
public class TranslationUnit {
    ...
    public enum ExtractionPattern {
        ...
        NEW_GHTML_LABEL, NEW_JMENU_ITEM, NEW_JMENU, NEW_JCHECK_BOX, NEW_JRADIO_BUTTON,
        NEW_TITLED_BORDER, NEW_JFRAME, NEW_JDIALOG, PLUGIN_SHORT_DESC, PLUGIN_DESCRIPTION,
